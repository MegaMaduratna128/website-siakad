...
<div class="page-header" style="margin-top: 180px;">
    <h1><p align="center">PILIH KELAS</p></h1>
  </div>
<form action="tampil_mahasiswa.php" method="post">
  <input type='hidden' name='kelas' value=<?php echo $_POST['matkul'] ?> >
...
echo "
<select name='kelas'>";
$tampil=mysql_query("SELECT  * FROM kelas WHERE KODE_KELAS IN(SELECT KODE_KELAS FROM dosen WHERE NIP=$dosen)");
